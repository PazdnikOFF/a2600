...
| Классов затронуто у нас | **50** (10%) |
| Методов реализовано (совпало по имени) | **522** (8.1%) |
...
| **CORE** | 60 | 1216 | 323 | 26.6% | 18 |
| **REPORT** | 72 | 752 | 12 | 1.6% | 3 |
| **HW** | 40 | 598 | 4 | 0.7% | 1 |
| **MISC** | 27 | 543 | 59 | 10.9% | 6 |
...
| `KPatientStringOperation` | MISC | 12 | — | не начат |
| `KObject` | CORE | 12 | — | не начат |
| `KEncSettings` | CORE | 11 | — | не начат |
...
| `KDbStringOperation` | DB | 9 | — | не начат |
