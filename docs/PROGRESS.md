...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **125 self-test-режимов** (все PASS, регрессия —
`tools/selftest.sh`; последний прогон — в контейнере на hermes, PASS 125 / FAIL 0).
...
templetmodel, dimmer, printdata, legalnotice, flexbtn, osdspin02, imglistcell, patnavitem, evtfilters, recorditem, poweroff, opendlgs, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer, smalllang, dimming, endoscope, camera, lcdproxy, factoryopt, docgen, monitor, rtcreator, videoipc, timemng.
