...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **117 self-test-режимов** (все PASS, регрессия —
`tools/selftest.sh`; последний прогон — в контейнере на hermes, PASS 117 / FAIL 0).
...
templetmodel, dimmer, printdata, legalnotice, flexbtn, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer, smalllang, dimming, endoscope, camera, lcdproxy, factoryopt, docgen, monitor, rtcreator, videoipc.
