...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **87 self-test-режимов** (все PASS, регрессия —
...
**ПОСЛЕДНЕЕ (эта сессия, 10-я итерация): АУДИТ ПОМЕТОК «device» + KEndoScope**
...
templetmodel, dimmer, printdata, legalnotice, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer, smalllang, dimming, endoscope.
