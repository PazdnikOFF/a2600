...
затронуто 73 класса / 744 метода (11.6%)** (report_template 28/36 = 78% — свободные функции
...
**ПОСЛЕДНЕЕ (эта сессия): `report_template::*` парсинг-конфигов (+4 функции, self-test
