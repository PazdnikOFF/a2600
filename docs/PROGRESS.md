...
затронуто 73 класса / 728 методов (11.3%)** (report_template 12/36 = 33%). Это нижняя оценка (считает совпадение имён;
...
**ПОСЛЕДНЕЕ (эта сессия): `report_template::*` (6 функций, self-test `reporttmpl`)** — декод
