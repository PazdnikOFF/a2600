...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **84 self-test-режима** (все PASS, регрессия —
...
**ПОСЛЕДНЕЕ (эта сессия, 6-я итерация): KVideoPlayerMng — список воспроизведения**
...
templetmodel, dimmer, printdata, legalnotice, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer.
