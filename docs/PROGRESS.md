...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **121 self-test-режим** (все PASS, регрессия —
`tools/selftest.sh`; последний прогон — в контейнере на hermes, PASS 121 / FAIL 0).
...
templetmodel, dimmer, printdata, legalnotice, flexbtn, osdspin02, imglistcell, patnavitem, evtfilters, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer, smalllang, dimming, endoscope, camera, lcdproxy, factoryopt, docgen, monitor, rtcreator, videoipc.
