...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **81 self-test-режим** (все PASS, регрессия —
...
**ПОСЛЕДНЕЕ (эта сессия, 2-я итерация): KExportRecord — экспорт осмотра на USB**
...
templetmodel, dimmer, printdata, legalnotice, autotest, exambiz, exportrec.
