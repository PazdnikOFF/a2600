...
затронуто 73 класса / 733 метода (11.4%)** (report_template 17/36 = 47%). Это нижняя оценка (считает совпадение имён;
...
**ПОСЛЕДНЕЕ (эта сессия): `report_template::*` навигация по дереву (+5 функций, self-test
