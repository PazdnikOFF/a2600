...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **82 self-test-режима** (все PASS, регрессия —
...
**ПОСЛЕДНЕЕ (эта сессия, 3-я итерация): KImageProcess — обработка изображений**
...
templetmodel, dimmer, printdata, legalnotice, autotest, exambiz, exportrec, imgproc.
