...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **114 self-test-режимов** (все PASS, регрессия —
`tools/selftest.sh`; последний прогон — в контейнере на hermes, PASS 114 / FAIL 0).
...
- ГРАНИЦА ПОРТА (честно): тела шести конкретных творцов НЕ реверсированы — они сделаны
  ЗАПИСЫВАЮЩИМИ заглушками, фиксирующими (творец, id, params). Портирован сам движок:
  реестр, выбор творца и раскрутка повторов.
