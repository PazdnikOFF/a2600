...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **80 self-test-режимов** (все PASS, регрессия —
...
**ПОСЛЕДНЕЕ (эта сессия): KExamBussinessHandler — жизненный цикл осмотра**
...
templetmodel, dimmer, printdata, legalnotice, autotest, exambiz.
