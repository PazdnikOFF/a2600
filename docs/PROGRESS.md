...
затронуто 84 класса / 875 методов (13.6%)** (report_template 28/36 = 78% — свободные функции
...
**ПОСЛЕДНЕЕ (эта сессия): `KSysReportTempletModel` (21/21) + `KSysReportTempletControl` (27/27)
