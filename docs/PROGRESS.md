...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **118 self-test-режимов** (все PASS, регрессия —
`tools/selftest.sh`; последний прогон — в контейнере на hermes, PASS 118 / FAIL 0).
...
templetmodel, dimmer, printdata, legalnotice, flexbtn, osdspin02, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer, smalllang, dimming, endoscope, camera, lcdproxy, factoryopt, docgen, monitor, rtcreator, videoipc.
