...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **122 self-test-режима** (все PASS, регрессия —
`tools/selftest.sh`; последний прогон — в контейнере на hermes, PASS 122 / FAIL 0).
...
templetmodel, dimmer, printdata, legalnotice, flexbtn, osdspin02, imglistcell, patnavitem, evtfilters, recorditem, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer, smalllang, dimming, endoscope, camera, lcdproxy, factoryopt, docgen, monitor, rtcreator, videoipc.
