...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **120 self-test-режимов** (все PASS, регрессия —
`tools/selftest.sh`; последний прогон — в контейнере на hermes, PASS 120 / FAIL 0).
...
templetmodel, dimmer, printdata, legalnotice, flexbtn, osdspin02, imglistcell, patnavitem, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer, smalllang, dimming, endoscope, camera, lcdproxy, factoryopt, docgen, monitor, rtcreator, videoipc.
