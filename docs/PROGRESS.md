...
**ОСТАЛОСЬ по KDocumentGenerator:** документная/render-половина — вся на QTextDocument/
QTextCursor/QTextTable. РАЗВЕДАНА (декомпилятор, готова к отдельной итерации 5):
