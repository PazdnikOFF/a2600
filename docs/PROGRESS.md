...
затронуто 73 класса / 740 методов (11.5%)** (report_template 24/36 = 67%). Это нижняя оценка (считает совпадение имён;
...
**ПОСЛЕДНЕЕ (эта сессия): `report_template::*` Customed-семейство (+4 функции, self-test
