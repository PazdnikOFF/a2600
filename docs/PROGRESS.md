...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **88 self-test-режимов** (все PASS, регрессия —
...
**ПОСЛЕДНЕЕ (эта сессия, 11-я итерация): KCamera** (self-test `camera`,
...
templetmodel, dimmer, printdata, legalnotice, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer, smalllang, dimming, endoscope, camera.
