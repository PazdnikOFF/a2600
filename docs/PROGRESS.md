...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **86 self-test-режимов** (все PASS, регрессия —
...
**ПОСЛЕДНЕЕ (эта сессия, 9-я итерация): K3ADimming — авто-диммирование 3A**
...
templetmodel, dimmer, printdata, legalnotice, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer, smalllang, dimming.
