...
**ТЕКУЩАЯ ПОЗИЦИЯ (обновлять!):** **85 self-test-режимов** (все PASS, регрессия —
...
**ПОСЛЕДНЕЕ (эта сессия, 7-я итерация): KSmallLangTranslate — раскладки «малых языков»**
...
templetmodel, dimmer, printdata, legalnotice, autotest, exambiz, exportrec, imgproc, reportedit, videoplayer, smalllang.
