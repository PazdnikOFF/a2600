...
- **Реализовано классов (по имени):** ~47 (эта сессия +7: KVideoCal, KUpdateManifest,
  KSysReportTempletCfg, KReportDBTableHandler-пагинация, KSaveFile, KUserOsdSet, KEntityService) +
...
- **Проверяемое off-device ядро (27 self-test-режимов, все PASS):** plreg, filt, dicom, report,
