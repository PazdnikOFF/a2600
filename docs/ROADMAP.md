...
KPatientListWidgetItem, KTableWidget, KPosNameLineEditDelegate, KPoweroff,
...
семейство event-фильтров (KEventFilter, KGlobalEventFilter, KHoverEventFilter,
KLabelHoverEventFilter — поведенческий слой UI).
