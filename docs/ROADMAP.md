...
- **Покрытие по именам классов:** ~13% методов. НО реализованные классы покрыты ЧАСТИЧНО
  ...
  | KVideoProxy | 121 | ~51 | init/capture/снимок/ApplyImageParams/AEC-AGC(keep-alive)/getAecValue/FreezeCalResolution/Demoire/тонкие Set*Level-Size-AwbCut-CHb/RBC/Denoise |
