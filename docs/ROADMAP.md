...
- Сейчас: **106/485 классов затронуто (22%)**, из них доведено до self-test ~57;
  **1246/6431 методов (19.4%)**; **57 self-test-режимов** (регрессия `tools/selftest.sh` — 90 проверок).
- По верифицируемости: off-device ✅ — **743/1843 (40.3%)**; частично ⚠️ — 201/1112 (18.1%);
  device-bound ❌ — 302/3476 (8.7%).
