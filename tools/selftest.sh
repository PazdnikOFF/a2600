...
camera endoscope dimming smalllang videoplayer reportedit imgproc exportrec savefile dbservice dispparam pattime recfiles kconfig strutil templateparam dbfileop patstr stopwatch patient doctor dbstr session textblock tableblock titletableblock reporttmpl examdata kobject xmlparser dbsqlite des templetmodel docgen monitor rtcreator videoipc screenmng rtdatasource listbuff rttext rtimage rttable findcell selectitem docedit movefb changecolor initdoc"
